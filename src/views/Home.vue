<template>
    <section class="site-body">
      <section class="site-body-content">
        ...
        <section class="cards">
          <div class="card">
            <a href="">Here are some projects I’ve worked on.</a>
          </div>

          <div class="card">
            <a href="">Learn more about my process and my history as a UX designer.</a>
          </div>

          <div class="card">
            <a href="">Ready to talk? Here’s where you can find me.</a>
          </div>
