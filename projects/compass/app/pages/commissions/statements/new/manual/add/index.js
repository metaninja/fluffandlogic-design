    ...
    wizard: [
        {
            ...
            route: "#/app/pages/commissions/statements/new/manual/"
        },
        {
            complete: false,
            active: false,
            label: "Add & Approve Commissions",
            route: "#/app/pages/commissions/statements/new/manual/add/"
        },
    ]
};
...
function toggleCallouts() {
    $(".js-valid-callouts").toggleClass('hide-content');
    $(".js-invalid-callouts").toggleClass('hide-content');
    changeButtonColors();
}
