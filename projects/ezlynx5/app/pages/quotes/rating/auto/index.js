function saveAndExit() {
    if (localStorage.autoApplicationComplete === "true") {
        incompleteAutoApplication();
    } else {
        completeAutoApplication();
    }
}
...
function incompleteAutoApplication() {
	localStorage.setItem("autoApplicationComplete", false);
...
$(function() {
	if (localStorage.autoApplicationComplete === "false" || localStorage.autoApplicationComplete === undefined) {
		incompleteAutoApplication();
	} else {
		completeAutoApplication();
	}
