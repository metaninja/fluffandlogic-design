...
function toggleApplyAutoCoverages() {
	var val = this.checked;
	$(".js-additional-option .js-auto-coverages-input .form-control").attr("disabled", val);
}

function toggleApplyAutoDeductibles() {
	var val = this.checked;
	$(".js-additional-option .js-auto-deductibles-input .form-control").attr("disabled", val);
}

function toggleApplyAutoDiscounts() {
	var val = this.checked;
	$(".js-additional-option .js-auto-discounts-input input").attr("disabled", val);
}
