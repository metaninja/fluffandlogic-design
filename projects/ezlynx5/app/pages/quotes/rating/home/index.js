function saveAndExit() {
    if (localStorage.homeApplicationComplete === "true") {
        incompleteHomeApplication();
    } else {
        completeHomeApplication();
    }
}

function completeHomeApplication() {
	localStorage.homeApplicationComplete = true;
...
function incompleteHomeApplication() {
	localStorage.setItem("homeApplicationComplete", false);
...
$(function() {
	if (localStorage.homeApplicationComplete === "false" || localStorage.homeApplicationComplete === undefined) {
		incompleteHomeApplication();
	} else {
		completeHomeApplication();
	}
